...
## ✅ Prerequisites
- [Module 01](../01-grundlagen-arbeitselemente-erzeugen/README.en.md) to [Module 04](../04-kanban-board-anpassen/README.en.md) have been completed
...
4. In the upper right corner, click the gear icon **Team settings** (tooltip: *Configure team settings*). The **Team Configuration** dialog opens.
5. Switch to the **Iterations** tab.
6. Click **Select iteration(s)** and add the three sprint paths you just created one after another:
   - `Maria\Sprint 1`
   - `Maria\Sprint 2`
   - `Maria\Sprint 3`
7. Optionally set **Maria\Sprint 1** as the **Default iteration** for new work items.
8. Close the dialog.
9. Verify by switching to **Boards > Sprints** that the three sprints are now available.
